...
## Website Code blocks, components and templates
...
- [developers google](https://developers.google.com/search/docs/fundamentals/seo-starter-guide?hl=es)

## Web Developer Check List
...
- [cisco skillsforall](https://skillsforall.com/career-path/cybersecurity?courseLang=en-US)
- [ccn](https://angeles.ccn-cert.cni.es/es/)
- [incibe](https://www.incibe.es/incibe/formacion/moocs)
- 
